...
public class TransactionStream
{
    ...
    {
        Transaction s1 = new Transaction(new Trader("Parvathi","warangal"), 2010, 10000);
        Transaction s2 = new Transaction(new Trader("Swetha","warangal"), 2011, 30000);
        Transaction s3 = new Transaction(new Trader("Prathyu","hyderabad"), 2011, 20000);
        Transaction s4 = new Transaction(new Trader("Pooja","vijayawada"),2013, 15000);
        ...
        t.stream().filter(p->p.trader.getCity().equalsIgnoreCase("warangal")).forEach(p->System.out.println(p.getValue()));
