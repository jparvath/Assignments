...
* The original package name 'io.javabrains.microservice.movies-catalog-service' is invalid and this project uses 'io.javabrains.microservice.moviescatalogservice' instead.
