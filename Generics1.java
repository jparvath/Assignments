 ...
 class Generics1
{
    ...
    public static void main(String args[]) {
        ...
        Employee<Integer,String,Integer,String> e1 =  new Employee<>(1201,"Parvathi",18000,"Cloud");
        Employee<Integer,String,Integer,String> e2 =  new Employee<>(1202,"Kavitha",16000,"SAP");
